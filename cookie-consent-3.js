...
(function () {
  ...
  function buildUI() {
    ...
    banner = el('div', { 'class': 'aic-banner', id: 'aic-banner', role: 'dialog', 'aria-label': 'Zgoda na pliki cookies', hidden: '' },
      '<div class="aic-inner">' +
        '<p class="aic-text">Używamy plików cookies. Niezbędne zapisują tylko Twój wybór z tego okna. Za Twoją zgodą włączamy też analityczne (Google Analytics) i marketingowe (piksele OpenAI i Meta), żeby mierzyć ruch i skuteczność reklam. Niezależnie od wyboru liczymy odsłony prostym licznikiem bez cookies (Cloudflare). <a href="polityka.html">Polityka prywatności</a></p>' +
